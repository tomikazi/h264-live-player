...
class TrainTracker {
    ...
    track() {
        if (this.location === 'forest' && this.nextTrack !== 'unknown' && this.running) {
            ...
            // Wait a bit and then start tracking view to the forest location
            this.time_track_to('tunnel', 4, 5000);
